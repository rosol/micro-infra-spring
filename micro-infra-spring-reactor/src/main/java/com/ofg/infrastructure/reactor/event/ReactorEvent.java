...
public class ReactorEvent<T> extends Event<T> {
    ...
    /**
     * Wrap the given object with an {@link reactor.event.Event}.
     *
     * @param obj The object to wrap.
     * @return The new {@link reactor.event.Event}.
     */
    ...
    /**
     * Wrap the given object with an {@link reactor.event.Event} and set the {@link reactor.event.Event#getReplyTo() replyTo} to the given {@code
     * replyToKey}.
     *
     * @param obj        The object to wrap.
