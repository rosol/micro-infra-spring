...
public class SwaggerConfiguration extends WebMvcConfigurerAdapter {
    @Bean
    public SwaggerSpringMvcPlugin swaggerSpringMvcPlugin(@Value("${rest.api.version:1.0}") String restApiVersion,
        ...
        return new SwaggerSpringMvcPlugin(springSwaggerConfig).apiInfo(new ApiInfo(restApiTitle,
                                                                        restApiDescription,
                                                                        restApiTerms,
                                                                        restApiContact,
                                                                        restApiLicenseType,
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/**", "/swagger/**", "/images/**", "/lib/**", "/css/**").addResourceLocations("classpath:/static/swagger/**", "classpath:/static/swagger/images/**", "classpath:/static/swagger/lib/**", "classpath:/static/swagger/css/**");
    }
